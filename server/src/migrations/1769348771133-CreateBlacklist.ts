...
export class CreateBlacklist1769348771133 implements MigrationInterface {
    name = 'CreateBlacklist1769348771133'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`blacklisted_token\` (\`id\` int NOT NULL AUTO_INCREMENT, \`token\` varchar(512) NOT NULL, \`expiresAt\` datetime NOT NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
