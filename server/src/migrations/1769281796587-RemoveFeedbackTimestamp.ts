...
export class RemoveFeedbackTimestamp1769281796587 implements MigrationInterface {
    name = 'RemoveFeedbackTimestamp1769281796587'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`feedback\` ADD CONSTRAINT \`FK_326c785b6f3c1c5c7eb8c2ed136\` FOREIGN KEY (\`messageId\`) REFERENCES \`message\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`feedback\` ADD \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6)`);
    }
